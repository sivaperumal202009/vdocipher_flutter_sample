...
class _CustomVdoPlayerViewState extends State<CustomVdoPlayerView> {
  ...
  Widget build(BuildContext context) {
    widget.service.onOrientationChange(MediaQuery.of(context).orientation);
...
class _VdoControlsBar extends StatelessWidget {
                      ...
                      children: [
                        ...
                        if (service.hasSubtitles) ...[
                          ...
                          _CustomControlIcon(
                            ...
                            onPressed: () => _onSearchCaptionPressed(context),
                            iconColor: service.primaryColor,
                          ),
                        ],
                        if (service.hasSpeed)
                    ...
                    children: [
                      ...
                      ValueListenableBuilder<String>(
                        ...
                        builder: (context, durationString, _) {
                          ...
                          final chapterTitle =
                              service.currentVideoChapter?.title;
  ...
  void _onSearchCaptionPressed(BuildContext context) {
    showDialog(
      context: context,
      barrierDismissible: false,
      barrierColor: ColorResource.color000000.withOpacity(0.39),
      builder: (context) {
        return Dialog(
          ...
          child: Container(
            ...
            child: ValueListenableBuilder(
              valueListenable: service.selectedSearchLang,
              builder: (context, selectedSearchLang, child) {
                return Column(
                  children: [
                    Row(
                    ...
                    if (selectedSearchLang == null) ...[
                      CustomText(
                        StringConstants.chooselanguage,
                      ...
                      Expanded(
                        child: ListView.builder(
                          shrinkWrap: true,
                          itemCount:
                              service.videoDetailResponse.captions?.length,
                          itemBuilder: (context, index) {
                            final item =
                                service.videoDetailResponse.captions![index];
                            return InkWell(
                              onTap: () {
                                service.setSearchLang(item.lang);

                                service.onCaptionSearch(
                                    "",
                                    service.videoDetailResponse.captions!
                                        .firstWhere((element) =>
                              ...
                              child: Container(
                                ...
                                child: Row(
                                  children: [
                                    CustomText(item.lang, font: service.font),
                                  ],
                                ),
                              ),
                            );
                      ...
                      Expanded(
                        child: ValueListenableBuilder(
                          valueListenable: service.videoDetailResponse.captions!
                              .firstWhere((element) =>
                                  element.lang == selectedSearchLang)
                              .searchSubTitle,
                              ...
                              children: [
                                ...
                                if (subtitle.isEmpty)
                                  ...
                                  Expanded(
                                    ...
                                    itemBuilder: (context, index) {
                                      final item = subtitle[index];
                                      return InkWell(
                                        onTap: () {
                                          service.changePosition(
                                              double.parse(item.startTime));
                                          service.setSearchLang(null);
                                          service.onCaptionSearch(
                                              "",
                                              service
